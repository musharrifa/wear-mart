...
<form action="" method="post" class="add-product-form" enctype="multipart/form-data">
   ...
   <input type="float" name="p_price"  placeholder="enter the product price" class="box" required>
...
<section class="edit-form-container">
   ...
   <form action="admin.php" method="post" enctype="multipart/form-data">
      ...
      <input type="float" min="0" class="box" required name="update_p_price" value="<?php echo $fetch_edit['price']; ?>">
